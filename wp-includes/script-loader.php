...
function wp_default_scripts( &$scripts ) {
	...
	if ( is_admin() ) {
		...
		$scripts->add( 'schedule', '/wp-includes/js/jquery/jquery.schedule.js', array('jquery'), '20');
		//$scripts->add( 'thickbox', '/wp-includes/js/thickbox/thickbox.js', array('jquery'), '3.1');
		$scripts->add('jquery-carousel','/wp-includes/js/jquery/jcarousel.js',array('jquery'),'0.22');
		$scripts->add( 'swfupload', '/wp-includes/js/swfupload/swfupload.js', false, '2.0.2');
		$scripts->add( 'swfupload-degrade', '/wp-includes/js/swfupload/plugins/swfupload.graceful_degradation.js', array('swfupload'), '2.0.2');

		$scripts->add( 'jquery-latest', '/wp-includes/js/jquery/jquery.js.1.2.6', false, '1.2.6');
		$scripts->add( 'ui-core-latest', '/wp-includes/js/jquery/ui.core.js', array('jquery-latest'), '1.2');
		$scripts->add('ui-tabs-latest', '/wp-includes/js/jquery/ui.tabs-new.js', array('ui-core-latest'), '3');
		//$scripts->add('jqmodal','/wp-includes/js/jquery/jqModal.js',array('jquery-latest'),'0.1.3');
		$scripts->add('thickbox','/wp-includes/js/jquery/thickbox-compressed.js',array('jquery-latest'),'3.1');
		
		//This is for all the flash checks
		$scripts->add('flash-check','/wp-includes/js/AC_OETags.js',false,'1.6');

		$scripts->add( 'moo-tools', '/wp-includes/js/gallery/mootools.v1.11.js', false, '1.11');
		$scripts->add('jd-gallery','/wp-includes/js/gallery/jd.gallery.js',array('moo-tools'),'2.0');
