...
jQuery(document).ready(function($){
       // Do jQuery stuff using $
		...
		$("div.fw_tabs_tabdisplay").each(function(i){
			...
			totalWidth = $(this).parents("div.fw_tabs_tabs_surround").width();
		...
		function fwst_display_tab( eventObject ){
			...
			$(this).parents('div.fw_tabs_tabdisplay').children('div').hide();
			$(this).parents('div.fw_tabs_tabdisplay').children('div').empty();
			$(this).parents('div.fw_tabs_tabdisplay').children('div').append($(this).parents('div.fw_tabs_tabdisplay').find('ul li h3.fwTabTitle.selected').siblings('div.tab-content').clone(true));
			$(this).parents('div.fw_tabs_tabdisplay').children('div').show();
		...
		function fwst_display_tab_level ( eventObject ){
			...
			//hide the old ones
			$( 'li.fwttl'+ currentTabLevel , $(this).parents("ul") ).hide();
