<?php
	//echo '<script type="text/javascript" src="'.get_settings('siteurl').'/wp-content/plugins/ajax-comment-posting/jquery.js"></script>';
        //echo '<script type="text/javascript" src="'.get_settings('siteurl').'/wp-includes/js/jquery/jcarousel.js"></script>';
...
<div id="featureThingy">
  <ul id="mycarousel" class="jcarousel-skin-tango">
        <?php
        c2c_get_recent_posts(5,"<li><a href=\"%post_url%\">News: %post_title%</a></li>",'22');
        ?>
  </ul>
</div>